...
#define fixedpt_fromint(I) ((int32_t)I << FIXEDPT_FBITS)	//整数的定点化
...
#define FIXEDPT_1	(int32_t)(1 << FIXEDPT_FBITS)		//定点数的1
#define FIXEDPT_3	(int32_t)(3 << FIXEDPT_FBITS)		//定点数的3
#define FIXEDPT_4	(int32_t)(4 << FIXEDPT_FBITS)		//定点数的4
#define FIXEDPT(I)	(int32_t)((I) << FIXEDPT_FBITS)		//定点数
